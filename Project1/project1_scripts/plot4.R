...
screen(2)
plot(newdata$Voltage, newdata$Dtime, type="l", axes=FALSE, ann=FALSE)
axis(1, at=pos, lab=wd)
axis(2, las=1, at=2*115:124)
box()
title(xlab="datetime")
title(ylab="Voltage")
...
legend("topright", legnames, col=plot_colors, lty=1:1, cex=0.5, bty="n")

screen(4)
plot(newdata$Global_reactive_power, newdata$DTime, type="l", axes=FALSE, ann=FALSE)
axis(1, at=pos, lab=wd)
